...
機械学習では，新たに特徴量をデータに追加することが頻繁に行われる．全ての行の数値が同じ列を追加するには，新しい列を指定して数値を代入する文を書く．また，行数と要素数が等しい場合は，新しい列を指定して\texttt{<ndarray>}や\texttt{<list>}を代入する文を書くことでその配列を追加することができる．
